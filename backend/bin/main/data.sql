...
-- Languages (4 languages: English, Hindi, Tamil, Kannada)
...
-- Analytics Events (sample data for H2 - uses DATEADD for date math)
...
('USR001', 'sess_today_001', 'hindi', 'text', 'kyc', 'kyc_status', true, false, 0.95, DATEADD('HOUR', -1, CURRENT_TIMESTAMP)),
('USR002', 'sess_today_002', 'hindi', 'text', 'transaction', 'transaction_status', true, false, 0.88, DATEADD('HOUR', -2, CURRENT_TIMESTAMP)),
('USR002', 'sess_today_003', 'tamil', 'text', 'mutual_fund', 'fund_info', true, false, 0.92, DATEADD('HOUR', -3, CURRENT_TIMESTAMP)),
('USR003', 'sess_today_004', 'telugu', 'text', 'kyc', 'kyc_documents', true, false, 0.90, DATEADD('HOUR', -4, CURRENT_TIMESTAMP)),
('USR003', 'sess_today_005', 'kannada', 'text', 'account', 'account_status', true, false, 0.85, DATEADD('HOUR', -5, CURRENT_TIMESTAMP)),
('USR001', 'sess_today_006', 'english', 'text', 'transaction', 'payment_failed', true, false, 0.91, DATEADD('HOUR', -6, CURRENT_TIMESTAMP)),
('USR001', 'sess_today_007', 'hindi', 'text', 'mutual_fund', 'sip_info', true, false, 0.87, DATEADD('HOUR', -7, CURRENT_TIMESTAMP)),
('USR002', 'sess_today_008', 'tamil', 'text', 'kyc', 'kyc_status', true, true, 0.45, DATEADD('HOUR', -8, CURRENT_TIMESTAMP)),
('USR001', 'sess_today_009', 'hindi', 'voice', 'transaction', 'refund_status', true, false, 0.93, DATEADD('HOUR', -9, CURRENT_TIMESTAMP)),
('USR003', 'sess_today_010', 'telugu', 'text', 'account', 'account_blocked', true, true, 0.40, DATEADD('HOUR', -10, CURRENT_TIMESTAMP)),
('USR001', 'sess_yest_001', 'hindi', 'text', 'mutual_fund', 'portfolio_view', true, false, 0.96, DATEADD('DAY', -1, CURRENT_TIMESTAMP)),
('USR002', 'sess_yest_002', 'tamil', 'text', 'kyc', 'kyc_status', true, false, 0.89, DATEADD('HOUR', -27, CURRENT_TIMESTAMP)),
('USR003', 'sess_yest_003', 'telugu', 'text', 'transaction', 'transaction_history', true, false, 0.91, DATEADD('HOUR', -28, CURRENT_TIMESTAMP)),
('USR001', 'sess_yest_004', 'kannada', 'voice', 'mutual_fund', 'sip_info', true, false, 0.84, DATEADD('HOUR', -29, CURRENT_TIMESTAMP)),
('USR001', 'sess_yest_005', 'english', 'text', 'account', 'update_details', true, false, 0.88, DATEADD('HOUR', -30, CURRENT_TIMESTAMP)),
('USR002', 'sess_yest_006', 'hindi', 'text', 'kyc', 'kyc_documents', true, false, 0.92, DATEADD('HOUR', -31, CURRENT_TIMESTAMP)),
('USR002', 'sess_yest_007', 'tamil', 'text', 'transaction', 'payment_failed', true, true, 0.38, DATEADD('HOUR', -32, CURRENT_TIMESTAMP)),
('USR003', 'sess_yest_008', 'kannada', 'text', 'mutual_fund', 'fund_info', true, false, 0.90, DATEADD('HOUR', -33, CURRENT_TIMESTAMP)),
('USR001', 'sess_2d_001', 'hindi', 'text', 'transaction', 'refund_status', true, false, 0.94, DATEADD('DAY', -2, CURRENT_TIMESTAMP)),
('USR002', 'sess_2d_002', 'tamil', 'voice', 'kyc', 'kyc_status', true, false, 0.87, DATEADD('HOUR', -51, CURRENT_TIMESTAMP)),
('USR003', 'sess_2d_003', 'telugu', 'text', 'mutual_fund', 'portfolio_view', true, false, 0.91, DATEADD('HOUR', -53, CURRENT_TIMESTAMP)),
('USR001', 'sess_2d_004', 'english', 'text', 'account', 'account_status', true, false, 0.86, DATEADD('HOUR', -55, CURRENT_TIMESTAMP)),
('USR003', 'sess_2d_005', 'hindi', 'text', 'account', 'account_blocked', true, true, 0.35, DATEADD('HOUR', -57, CURRENT_TIMESTAMP)),
('USR001', 'sess_3d_001', 'hindi', 'text', 'mutual_fund', 'sip_info', true, false, 0.93, DATEADD('DAY', -3, CURRENT_TIMESTAMP)),
('USR002', 'sess_3d_002', 'tamil', 'text', 'transaction', 'payment_failed', true, false, 0.85, DATEADD('HOUR', -76, CURRENT_TIMESTAMP)),
('USR003', 'sess_3d_003', 'telugu', 'text', 'kyc', 'kyc_documents', true, false, 0.90, DATEADD('HOUR', -78, CURRENT_TIMESTAMP)),
('USR001', 'sess_4d_001', 'hindi', 'text', 'kyc', 'kyc_status', true, false, 0.95, DATEADD('DAY', -4, CURRENT_TIMESTAMP)),
('USR002', 'sess_5d_001', 'telugu', 'text', 'transaction', 'refund_status', true, false, 0.87, DATEADD('DAY', -5, CURRENT_TIMESTAMP)),
('USR003', 'sess_6d_001', 'english', 'text', 'account', 'account_status', true, false, 0.89, DATEADD('DAY', -6, CURRENT_TIMESTAMP)),
('USR001', 'sess_6d_002', 'hindi', 'voice', 'transaction', 'transaction_history', true, true, 0.42, DATEADD('HOUR', -154, CURRENT_TIMESTAMP)),
('USR002', 'sess_7d_001', 'tamil', 'text', 'mutual_fund', 'sip_info', true, false, 0.88, DATEADD('DAY', -7, CURRENT_TIMESTAMP)),
('USR003', 'sess_7d_002', 'telugu', 'text', 'kyc', 'kyc_documents', true, false, 0.90, DATEADD('HOUR', -177, CURRENT_TIMESTAMP));
